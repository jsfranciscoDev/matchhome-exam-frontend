        ...
        <header className="absolute inset-x-0 top-0 z-50">
            <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    {authStatus ? (
                        <a href="" className="text-sm font-semibold leading-6 text-gray-900" onClick={ logout }>Sign Out</a>
                    ) : (
                        <Link href="/" className="text-sm font-semibold leading-6 text-gray-900">Login</Link>
                    )}
                </div>
            </nav>
                    ...
                    <div className="flow-root mt-6">
                        <div className="-my-6 divide-y divide-gray-500/10">
                            <div className="py-6 space-y-2">
                                <a href="#" className="block px-3 py-2 -mx-3 text-base font-semibold leading-7 text-gray-900 rounded-lg hover:bg-gray-50">Product</a>
